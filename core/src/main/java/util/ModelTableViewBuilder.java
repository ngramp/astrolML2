package util; /**
 * @see https://github.com/Arkm4n/MTV-Builder/blob/master/src/com/aberezkin/tablebuilder/builder/ModelTableViewBuilder.java
 *
 * @author Arkm4n
 */
...
public class ModelTableViewBuilder<M> extends TableView<M> {
    private static final Logger logger = LoggerFactory.getLogger(ModelTableViewBuilder.class);
    /**
     * Hidden constructor.
     */
